  ...
  <div class="hero bg-white mb-16">
    <div class="container mx-auto px-4 lg:px-0">
      <div class="flex flex-col-reverse lg:flex-row items-center justify-between py-10">
        ...
        <img class="w-full lg:w-1/2 mb-3 lg:mb-0" src="@/assets/img/hero.png" alt="">
      </div>
    </div>
  </div>
  <div class="categories bg-white py-20">
    <div class="container mx-auto px-4 lg:px-0">
      ...
      <div v-if="catalog.accData" class="block lg:flex justify-between">
        <NuxtLink :to="'categories/' + item.id" class="relative cursor-pointer mb-3 lg:mb-0 block justify-center" v-for="(item, index) of catalog.accData" :key="index">
          <img class="w-[185px] h-[185px] mx-auto mb-4" :src="runtimeConfig.public.IMAGE_LINK + item.image" alt="">
          <div v-if="index % 2 === 0"
               class="w-[185px] h-[185px] left-1/2 -translate-x-1/2 lg:translate-x-0 mx-auto rounded-full bg-mainColor bg-opacity-50 absolute lg:left-0 top-0"></div>
          <div v-else
      ...
      <div v-else class="flex justify-between">
        <div v-for="(item, index) of 5" :key="index" class="w-[185px] h-[185px] mx-auto">
          <div class="skeleton w-[185px] h-[185px] mb-3"></div>
      ...
      <div class="block lg:flex justify-between">
        <div class="w-full lg:w-[45%] bg-mainColor px-11 pt-11">
          <div class="w-full relative">
            <img class="w-full mb-3 relative z-10" src="@/assets/img/brands/first.png" alt="">
        ...
        <div class="w-full lg:w-[55%]">
          <div class="h-1/2 block lg:flex justify-between">
            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-between px-7 py-11 relative">
              <img class="absolute left-0 top-0 w-full h-full" src="@/assets/img/brands/secondBg.png" alt="">
              <img class="w-full h-full object-contain mx-auto relative z-20" src="@/assets/img/brands/second.png"
                   alt="">
            </div>
          </div>
          <div class="h-1/2">
            <img class="w-full h-full" src="@/assets/img/brands/third.png" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container mx-auto px-4 lg:px-0 py-32">
    <div class="block lg:flex justify-between items-start">
      ...
      <div class="w-full lg:w-2/3 flex justify-end">
        <img src="@/assets/img/bi/bg.png" alt="">
      </div>
    </div>
  </div>
</template>
